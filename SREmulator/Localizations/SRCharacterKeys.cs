...
{
    public static class SRCharacterKeys
    {
        [SRCharacter(Bailu, 5)]
        [SRAliases("bailu")]
        public const string Bailu = nameof(Bailu);

        [SRCharacter(Bronya, 5)]
        [SRAliases("bronya", "buluoniya")]
        public const string Bronya = nameof(Bronya);

        [SRCharacter(Clara, 5)]
        [SRAliases("clara", "kelala")]
        public const string Clara = nameof(Clara);

        [SRCharacter(Gepard, 5)]
        [SRAliases("gepard", "jiepade")]
        public const string Gepard = nameof(Gepard);

        [SRCharacter(Himeko, 5)]
        [SRAliases("himeko", "jizi")]
        public const string Himeko = nameof(Himeko);

        [SRCharacter(Welt, 5)]
        [SRAliases("welt", "waerte")]
        public const string Welt = nameof(Welt);

        [SRCharacter(Yanqing, 5)]
        [SRAliases("yanqing")]
        ...
        public const string Arlan = nameof(Arlan);

        [SRCharacter(Asta, 4)]
        [SRAliases("asta", "aisida")]
        public const string Asta = nameof(Asta);

        [SRCharacter(DanHeng, 4)]
        [SRAliases("dan-heng", "danheng")]
        public const string DanHeng = nameof(DanHeng);

        [SRCharacter(Gallagher, 4)]
        [SRAliases("gallagher", "jialahe")]
        public const string Gallagher = nameof(Gallagher);

        [SRCharacter(Guinaifen, 4)]
        [SRAliases("guinaifen")]
        public const string Guinaifen = nameof(Guinaifen);

        [SRCharacter(Hanya, 4)]
        [SRAliases("hanya")]
        public const string Hanya = nameof(Hanya);

        [SRCharacter(Herta, 4)]
        [SRAliases("herta", "heita")]
        public const string Herta = nameof(Herta);

        [SRCharacter(Hook, 4)]
        [SRAliases("hook", "huke")]
        public const string Hook = nameof(Hook);

        [SRCharacter(Luka, 4)]
        [SRAliases("luka")]
        public const string Luka = nameof(Luka);

        [SRCharacter(Lynx, 4)]
        [SRAliases("lynx", "lingke")]
        public const string Lynx = nameof(Lynx);

        [SRCharacter(March7th, 4)]
        [SRAliases("march7th", "march", "sanyueqi")]
        public const string March7th = nameof(March7th);

        [SRCharacter(Misha, 4)]
        [SRAliases("misha")]
        public const string Misha = nameof(Misha);

        [SRCharacter(Moze, 4)]
        [SRAliases("moze")]
        public const string Moze = nameof(Moze);

        [SRCharacter(Natasha, 4)]
        [SRAliases("natasha")]
        public const string Natasha = nameof(Natasha);

        [SRCharacter(Pela, 4)]
        [SRAliases("pela", "peila")]
        public const string Pela = nameof(Pela);

        [SRCharacter(Qingque, 4)]
        [SRAliases("qingque")]
        public const string Qingque = nameof(Qingque);

        [SRCharacter(Sampo, 4)]
        [SRAliases("sampo", "sangbo")]
        public const string Sampo = nameof(Sampo);

        [SRCharacter(Serval, 4)]
        [SRAliases("serval", "xiluwa")]
        public const string Serval = nameof(Serval);

        [SRCharacter(Sushang, 4)]
        [SRAliases("sushang")]
        ...
        [SRCharacter(Xueyi, 4)]
        [SRAliases("xueyi")]
        public const string Xueyi = nameof(Xueyi);

        [SRCharacter(Yukong, 4)]
        [SRAliases("yukong")]
        public const string Yukong = nameof(Yukong);
    }
}
