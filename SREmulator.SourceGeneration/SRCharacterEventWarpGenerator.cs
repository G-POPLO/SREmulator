    ...
    public class SRCharacterEventWarpGenerator : ISourceGenerator
    {
        ...
        public void Execute(GeneratorExecutionContext context)
        {
            ...
            foreach (var member in keys.GetMembers())
            {
                ...
                var attributeDatas = member.GetAttributes(SRAttributes.SRCharacterEventWarpAttribute);
            ...
            builder.AppendLine("{");
            builder.AppendLine(1, "partial class SRCharacterEventWarps");
            builder.AppendLine(1, "{");
            foreach (var warp in warpsDatas.SelectMany(warpsData => warpsData.WarpDatas))
            {
                builder.AppendLine(2, $"private static SRCharacterEventWarp _{warp.Key}{warp.Index} = null;");
                builder.AppendLine(2, $"public static SRCharacterEventWarp {warp.Key}{warp.Index} => _{warp.Key}{warp.Index} ??= new {warp.Key}{warp.Index}();");
            }
            builder.AppendLine(2, "public static SRCharacterEventWarp GetWarpByNameAndVersion(string name, SRVersion version)");
            ...
            foreach (var warpsData in warpsDatas)
            {
                ...
                {
                    builder.AppendLine(5, $"SRVersion.Ver{warpData.Major}p{warpData.Minor} => SRCharacterEventWarps.{warpData.Key}{warpData.Index},");
                }
                builder.AppendLine(5, $"_ => SRCharacterEventWarps.{warpsData.WarpDatas[0].Key}{warpsData.WarpDatas[0].Index}");
                builder.AppendLine(4, "},");
            }
            builder.AppendLine(4, $"_ => SRCharacterEventWarps.{warpsDatas.Last().WarpDatas[0].Key}{warpsDatas.Last().WarpDatas[0].Index}");
            builder.AppendLine(3, "};");
            ...
            foreach (var warp in warpsDatas.SelectMany(warpsData => warpsData.WarpDatas))
            {
                builder.AppendLine(1, $"public sealed class {warp.Key}{warp.Index} : SRCharacterEventWarp");
                builder.AppendLine(1, "{");
                builder.AppendLine(2, $"public override SRVersion Version => SRVersion.Ver{warp.Major}p{warp.Minor};");
                builder.AppendLine(2, $"public override SRStar5Character UpStar5Character => SRCharacters.{warp.Up5};");
                builder.AppendLine(2, $"public override SRStar4Character UpStar4Character1 => SRCharacters.{warp.Up41};");
                builder.AppendLine(2, $"public override SRStar4Character UpStar4Character2 => SRCharacters.{warp.Up42};");
                builder.AppendLine(2, $"public override SRStar4Character UpStar4Character3 => SRCharacters.{warp.Up43};");
                builder.AppendLine(1, "}");
                builder.AppendLine();
            }
