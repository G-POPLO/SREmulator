...
namespace SREmulator.SourceGeneration
{
    ...
    public class SRCharacterGenerator : ISourceGenerator
    {
        ...
        public void Execute(GeneratorExecutionContext context)
        {
            ...
            builder.AppendLine("{");
            builder.AppendLine("    partial class SRCharacters");
            builder.AppendLine("    {");
            foreach (var character in characters)
            {
                builder.AppendLine($"        private static {character.Type} _{character.Key} = null;");
                builder.AppendLine($"        public static {character.Type} {character.Key} => _{character.Key} ??= new {character.Key}();");
            }
            builder.AppendLine("    }");
            builder.AppendLine();
