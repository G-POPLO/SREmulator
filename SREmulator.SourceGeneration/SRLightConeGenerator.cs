...
namespace SREmulator.SourceGeneration
{
    ...
    public class SRLightConeGenerator : ISourceGenerator
    {
        ...
        {
            context.RegisterForSyntaxNotifications(SRKeysClassReceiver.Creator(SRKeys.SRLightConeKeys));
        }
        ...
        public void Execute(GeneratorExecutionContext context)
        {
            ...
            {
                var attributeData = member.GetAttribute(SRAttributes.SRLightConeAttribute);
            ...
            builder.AppendLine("{");
            builder.AppendLine(1, "partial class SRLightCones");
            builder.AppendLine(1, "{");
            foreach (var lightCone in lightCones)
            {
                builder.AppendLine(2, $"private static {lightCone.Type} _{lightCone.Key} = null;");
                builder.AppendLine(2, $"public static {lightCone.Type} {lightCone.Key} => _{lightCone.Key} ??= new {lightCone.Key}();");
            }
            builder.AppendLine(1, "}");
            builder.AppendLine();
